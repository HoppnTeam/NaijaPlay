...
-- Ensure team_players table has proper foreign key constraints
ALTER TABLE team_players
    DROP CONSTRAINT IF EXISTS team_players_team_id_fkey,
...
-- Recreate the buy_player function with proper error handling
